...
public abstract class Hero extends Character {
	...
	public void setActionsAvailable(int actionsAvailable) {
		...
		for(CharacterListener listener : listeners){
			listener.onPropertyChanged(this, "actionsAvailable", oldValue, this.actionsAvailable);
		}
	}
	...
	public void raiseSupplyCountChange(int oldValue) {
		for(CharacterListener listener : listeners){
			listener.onPropertyChanged(this, "supplyCount", oldValue, this.getSupplyInventory().size());
		}
	}
	public void raiseVaccineCountChange(int oldValue) {
		for(CharacterListener listener : listeners){
			listener.onPropertyChanged(this, "vaccineCount", oldValue, this.getVaccineInventory().size());
		}
	}
}
